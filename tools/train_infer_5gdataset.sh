...
# infer 5GDataset
echo 'test 5GDataset Area 12'
time ./tools/dist_test.sh configs/softgroup_5gdataset_area12.yaml checkpoints/softgroup_s3dis_spconv2.pth 1 exp-test/5GDataset/result-area12
