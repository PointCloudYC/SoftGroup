...
# infer val set
./tools/dist_test.sh configs/softgroup_scannet.yaml checkpoints/softgroup_scannet_spconv2.pth 4 exp-val/scannetv2/result 
...
# ./tools/dist_test.sh configs/softgroup_scannet_test.yaml checkpoints/softgroup_scannet_spconv2.pth 4 exp-test/scannetv2/result 
